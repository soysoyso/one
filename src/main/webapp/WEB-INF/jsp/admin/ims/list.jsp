    ...
    <div class="container">
        ...
        <div class="" style="display: flex !important; justify-content: space-between; align-items: center;">
            <div class="d-flex align-items-center gap-3">
                <p id="sosCount">접수 내역 (총 <b>0</b>건)</p>
                <div class="small-btn">
                    <div class="">
                        <select class="form-select" id="bulkFirstSettleStatus">
                            <option value="" selected="">전체 상태</option>
                            <option value="SETTLE_PLAN">접수</option>
                            <option value="SETTLE_DONE">작업</option>
                        </select>
                    </div>
                    <button type="button" class="btn btn-secondary" id="btnFirstSettleChange">변경</button>
                </div>
            </div>
            <button type="button" class="btn btn-primary" id="btnImsAdd"><i class="bi bi-plus"></i> 접수 등록</button>
        </div>
        ...
        <div class="data-zone">
            <table class="table">
                <thead>
                    <tr>
                        <th><input class="form-check-input" type="checkbox" value="" id="checkDefault"></th>
                        <th>상태</th>
                        <th>접수코드</th>
                        <th>작업내용</th>
                        <th>방향</th>
                ...
                <tr>
                    ...
                    <td class="danger">접수</td>
                    <td><a type="btn" data-bs-toggle="modal" data-bs-target="#ims-add-modal">IP251117001</a></td>
                    <td>포트홀 정비</td>
                    <td>상행</td>
                    <td>STA 110(갈마터널)</td>
                    <td>25-11-11 10:00</td>
                    <td>-</td>
                    <td>-</td>
                    <td><button type="button" class="btn btn-light" onclick="">보고서</button></td>
                </tr>
                <tr>
                    <td><input class="form-check-input" type="checkbox" value="" id="checkDefault"></td>
                    <td class="ing">작업중</td>
                    <td><a type="btn" data-bs-toggle="modal" data-bs-target="#ims-add-modal">IP251117002</a></td>
                    <td>포트홀 정비</td>
                    <td>상행</td>
                    <td>STA 110(한국다리)</td>
                    <td>25-12-17 14:24</td>
                    <td>-</td>
                    <td>-</td>
                    <td><button type="button" class="btn btn-light" onclick="">보고서</button></td>
                </tr>
                <tr>
                    ...
                    <td><a type="btn" data-bs-toggle="modal" data-bs-target="#ims-add-modal">IP251117003</a></td>
                    <td>포트홀 정비</td>
                    <td>하행</td>
                    <td>STA 110</td>
                    <td>26-01-04 08:27</td>
                    <td>26-01-05 10:31</td>
                    <td>1D 1H 10M</td>
                    <td><button type="button" class="btn btn-light" onclick="">보고서</button></td>
                </tr>
                <tr>
                    <td><input class="form-check-input" type="checkbox" value="" id="checkDefault"></td>
                    <td clas="hold">보류</td>
                    <td><a type="btn" data-bs-toggle="modal" data-bs-target="#ims-add-modal">IP251117004</a></td>
                    <td>포트홀 정비</td>
                    <td>하행</td>
                    <td>STA 110</td>
                    <td>26-02-21 17:31</td>
                    <td>26-02-21 21:01</td>
                    <td>10H</td>
                    <td><button type="button" class="btn btn-light" onclick="">보고서</button></td>
                </tr>
                </tbody>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#add-equipment', function() {
            const row = `<tr>
            <td><input type="text" class="form-control" placeholder="장비명"></td>
            <td><input type="number" class="form-control" placeholder="0"></td>
            <td><input type="text" name="latLng" class="form-control"></td>
	...
	$.ajax({
		...
		success: function(data) {
            ...
            if (imgUrl) {
                ...
                console.log("==========>" , document.getElementById('thumbnailContainer'));
                var col = document.createElement('div');
                col.className = 'col-auto';  // row 안에서 썸네일이 알아서 줄바꿈되게
